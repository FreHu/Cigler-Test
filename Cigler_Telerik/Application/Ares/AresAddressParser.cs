...
namespace Cigler_Telerik.Application.Ares
{
	public class AresAddressParser
	{
		...
		{
			return null;
			// chcel som tu nacitat adresu automaticky z aresu, no adresy v odpovedi nie su rovnakeho formatu, takze to nejde spolahlivo rozparsovat
			...
			var address = doc.Root.Element("Odpoved").Element("Zaznam").Element("Identifikace").Element("Adresa_ARES").Element("Adresa_textem").Value;
			address.Split(',');
